            ...
            <div class="card">
                <div class="row mx-1">
                    <div class="col">
                        ...
                        <div class="form-group">
                            <x-input-form-crud name="mailRecruteur" label="Email" type="text" placeholder="Mail du recruteur" />
                        </div>
                    ...
                    <div class="col">
                        ...
                        <div class="form-group">
                            <x-input-form-crud name="prestige" label="Prestige" type="text" placeholder="Prestige du recruteur" />
                        </div>
                        <div class="row">
                            <div class="col">
                                <x-my-select value="" :options="[
                                    ...
                                    ]" label="Est validé" name="estValide">
                                </x-my-select>
                            </div>
                            <div class="col">
                                <x-my-select value="" :options="[
